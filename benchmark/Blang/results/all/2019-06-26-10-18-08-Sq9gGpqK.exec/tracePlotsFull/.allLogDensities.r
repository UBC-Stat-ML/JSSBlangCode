...
p <- ggplot(data, aes(x = sample, y = value)) +
  ...
  xlab("MCMC iteration") +
  ylab("sample") +
  ggtitle("Trace plot for: allLogDensities")
ggsave("/home/kevinchern/blang/JSSBlangCode/benchmark/Blang/results/all/2019-06-26-10-18-08-Sq9gGpqK.exec/tracePlotsFull/allLogDensities.pdf", limitsize = F, height = verticalSize, width = horizontalSize)
