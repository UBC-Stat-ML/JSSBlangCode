...
write.csv(summary, "/home/kevinchern/blang/JSSBlangCode/benchmark/Blang/results/all/2019-06-26-10-18-08-Sq9gGpqK.exec/summaries/allLogDensities-summary.csv")
