...
p <- ggplot(data, aes(x = value)) +
  ...
  xlab("energy") +
  ylab("density") +
  ggtitle("Density plot for: energy")
ggsave("/home/kevinchern/blang/JSSBlangCode/benchmark/Blang/results/all/2019-06-26-10-18-08-Sq9gGpqK.exec/posteriorPlots/energy.pdf", limitsize = F, height = verticalSize, width = horizontalSize)
